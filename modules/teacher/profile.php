...
$stmt = $pdo->prepare("
    ...
    FROM schedules s
    LEFT JOIN activities a ON s.course_id = a.course_id AND a.teacher_id = ?
    WHERE s.teacher_id = ?
");
...
$stmt = $pdo->prepare("
    SELECT a.title, c.name as course_name, a.created_at,
...
<main class="container mx-auto px-6 py-8">
    <h2 class="text-3xl font-bold text-gray-800 mb-6 animate-slide-in-left flex items-center">
        <i class="fas fa-user-tie mr-4 text-primary"></i>
        Mi Perfil
    </h2>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-xl animate-fade-in-up">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Aulas Utilizadas</span>
                        <span class="font-bold text-blue-600"><?php echo $stats['total_classrooms']; ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Actividades Creadas</span>
                        <span class="font-bold text-green-600"><?php echo $stats['total_activities']; ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Horarios Programados</span>
                        <span class="font-bold text-purple-600"><?php echo $stats['total_schedules']; ?></span>
                    </div>
                    <div class="flex justify-between items-center">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-xl animate-fade-in-up">
                ...
                <?php else: ?>
                    <div class="text-center py-4">
                        ...
                        <p class="text-sm text-gray-500">No hay cursos asignados</p>
                    </div>
                <?php endif; ?>
            </div>
                ...
                <div class="space-y-3">
                    <a href="grades.php" class="block bg-white bg-opacity-20 hover:bg-opacity-30 p-3 rounded-lg transition duration-300">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm">Gestionar Calificaciones</span>
                        </div>
                    </a>
                    ...
                    <a href="attendance.php" class="block bg-white bg-opacity-20 hover:bg-opacity-30 p-3 rounded-lg transition duration-300">
                        <div class="flex items-center">
                            <i class="fas fa-user-check mr-3"></i>
                            <span class="text-sm">Control de Asistencia</span>
                        </div>
                    </a>
                </div>
            </div>
